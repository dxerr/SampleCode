...
public:
    ...
    */
    ...
    UFUNCTION(BlueprintPure, Category = "AI|Ex", Meta = (HidePin = "NodeOwner", DefaultToSelf = "NodeOwner"))
    static UGameObjectBase* GetBlackboardValueAsGameObjectEx(UBTNode* NodeOwner, const FName& KeyName);
    ...
    //블랙보드 파서 초기값 설정
    UFUNCTION(BlueprintCallable, Category = "AI|Ex", Meta = (HidePin = "NodeOwner", DefaultToSelf = "NodeOwner"))
    static void SetBlackboardEmptyData(UBTNode* NodeOwner, const FBTBlackboardDataParser& Parser);
